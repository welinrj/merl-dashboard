...
export function SkeletonCard({ height = 92 }) {
  return (
    <div className="card" role="status" aria-label="Loading" style={{ padding: '1rem 1.15rem' }}>
      <Keyframes />
...
export function SkeletonRows({ rows = 5, cols = 5 }) {
  return (
    <div role="status" aria-label="Loading" style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem', padding: '0.5rem 0' }}>
      <Keyframes />

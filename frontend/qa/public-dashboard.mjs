...
check('province chart drills down to matching projects',await page.locator('.pbd-project-row').count()===1 && await page.locator('.pbd-project-row').getByText('Water Security').count()===1);

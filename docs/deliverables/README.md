...
| 2 | [Prototype Dashboard](D2-prototype-dashboard.md) — deployed to staging for DoCC review & UAT | Day 24 (~24 Jul 2026) | In progress — live Supabase staging backend (auth + data), see `docs/staging.md` | |
| 3 | [Final Dashboard](D3-final-dashboard.md) — production deployment incl. UAT feedback, field forms, MFAT-aligned reports; admin access handed to DoCC *(GIS layers descoped — see change record)* | Day 28 (~28 Jul 2026) | Not started | |
| 4 | [Documentation & Training](D4-documentation-and-training.md) — role-specific user manual, technical architecture, sysadmin guide, migration runbook; 2 training sessions (M&E Officers Day 27, Field Staff Day 28) | Day 29 (~29 Jul 2026) | Docs drafted in `docs/`; training not yet scheduled | |
| 5 | [Final Report + full system handover](D5-final-report.md) incl. source code repository | Day 30 (~30 Jul 2026) | Not started | |
